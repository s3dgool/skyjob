          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              ...
              <div className="flex flex-col items-center mb-6 animate-in fade-in zoom-in duration-500">
                <div className="relative w-40 h-40 mb-6 bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-3xl p-6 shadow-2xl ring-1 ring-gray-200 dark:ring-gray-700 flex items-center justify-center transform transition-transform hover:scale-105">
